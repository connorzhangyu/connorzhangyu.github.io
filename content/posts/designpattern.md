---
title: designpattern
id: bf09859a-1c8d-4b7b-a9b3-915c1592cd0d
date: 2025-01-04 04:08:55
auther: connor
cover: null
excerpt: 设计模式 说一下你熟悉的设计模式？ 单例模式 简单点说，就是一个应用程序中，某个类的实例对象只有一个，你没有办法去new，因为构造器是被private修饰的，一般通过getInstance()的方法来获取它们的实例。 getInstance()的返回值是一个对象的引用，并不是一个新的实例，所以不要错
permalink: /archives/774f415e-d704-4de0-bcd1-9f655613dfaa
---
