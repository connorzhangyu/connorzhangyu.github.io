---
title: thread
id: ff9dad81-feb8-4134-8c55-d80e3e836da5
date: 2025-01-04 04:08:56
auther: connor
cover: null
excerpt: 线程 并行和并发有什么区别？ 并行是指两个或者多个事件在同一时刻发生；而并发是指两个或多个事件在同一时间间隔发生。 并行是在不同实体上的多个事件，并发是在同一实体上的多个事件。 在一台处理器上“同时”处理多个任务，在多台处理器上同时处理多个任务。如hadoop分布式集群。 所以并发编程的目标是充分的
permalink: /archives/b873c790-7eb8-4683-94b6-d820f1463c92
---
