---
title: jvm
id: 0d3b364d-ed10-40c3-872b-dd7459427776
date: 2025-01-04 04:08:55
auther: connor
cover: null
excerpt: JVM 说一下 jvm 的主要组成部分？及其作用？ 类加载器（ClassLoader） 运行时数据区（Runtime Data Area） 执行引擎（Execution Engine） 本地库接口（Native Interface） 组件的作用： 首先通过类加载器（ClassLoader）会把 Ja
permalink: /archives/3fef4ee1-f1fe-48de-bded-f0f7a7257a7a
---
